...
REF_POINT = [37.44985869, 126.65115854] # 대 운동장 한 가운데.
...
def calc_pos(string):
    ...
    f_E = tmp_E_f + tmp_E_e
    f_N, f_E, _ = pm.geodetic2enu(f_N, f_E, 0, REF_POINT[0], REF_POINT[1], 0)
...
with open("nmea_data/1_square.nmea", "r", encoding="utf-8") as f:
