...
if __name__ == "__main__":
    ...
    AVG_RTAP = np.average(RTAP_DATA, axis=0)
    AVG_iPhone = np.average(iPhone_DATA, axis=0)
    AVG_Galaxy = np.average(Galaxy_DATA, axis=0)

    print("Point at 4")
    print("STD_RTAP: ", np.std(RTAP_DATA, axis=0))
    print("STD_iPhone: ", np.std(iPhone_DATA, axis=0))
    print("STD_Galaxy: ", np.std(Galaxy_DATA, axis=0))
    print("diff iPhone from RTAP: ", AVG_RTAP - AVG_iPhone)
    print("diff Galaxy from RTAP: ", AVG_RTAP - AVG_Galaxy)
